...
proc_name="chunking_validator_autoupdate_child" 
args=()
...
if [ "$?" -eq 1 ]; then
    while true; do
        ...
        if [ -d "./.git" ]; then
            ...
            echo "The installation does not appear to be done through Git. Please install from source at https://github.com/VectorChat/chunking_subnet and rerun this script."
        fi
